sap.ui.require([
  ...
  var sViewName = "tutorial.me.myappui5.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "Title of tutorial.me.myappui5"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title tutorial.me.myappui5"
            });
        }
      }
